...
button = pyautogui.confirm('Scrape Amazon?', 'Amazon Search Rank ver1- created by JH')
if button == 'OK':
        ...
        for x in range(1, 8):
            ...
            for t in titles:
                ...
                if item.startswith("Spigen") and "Pro" not in item and "Urban" in item:
                    ...
                    pgn += item
                    fr_list_four.append(pgn)
                if item.startswith("Spigen") and "Pro" not in item and "Classic" in item:
                    pgn = f"PAGE: [{x}]===[CS]"
                    pgn += item
                    fr_list_four.append(pgn)
                if item.startswith("Spigen") and "Pro" not in item and "Silicon" in item:
                    ...
                    pgn += item
                    fr_list_four.append(pgn)
                if item.startswith("Spigen") and "Pro" not in item and "Slim" in item:
                    pgn = f"PAGE: [{x}]===[SA IP]"
                    pgn += item
                    fr_list_four.append(pgn)
